...
class find_music_url:
    ...
    def get_music_info(self,id):
        ...
        '''
        use_new_version = True  # 是否使用新版的爬虫方案（不稳定）有些歌曲会不显示歌词
        if use_new_version:
            key = f"NVPh5oo715z5DIWAeQlhMDsWXXQV4hwtappid=1014clienttime=1702886000709clientver=20000dfid=08xOJ20t94ra2yjw7b3RqEtzencode_album_audio_id={id}mid=95fc5a00ac4e7fc7b8d3e0a04230e9aaplatid=4srcappid=2919token=userid=0uuid=95fc5a00ac4e7fc7b8d3e0a04230e9aaNVPh5oo715z5DIWAeQlhMDsWXXQV4hwt"
            music_url = f"https://wwwapi.kugou.com/play/songinfo?srcappid=2919&clientver=20000&clienttime=1702886000709&mid=95fc5a00ac4e7fc7b8d3e0a04230e9aa&uuid=95fc5a00ac4e7fc7b8d3e0a04230e9aa&dfid=08xOJ20t94ra2yjw7b3RqEtz&appid=1014&platid=4&encode_album_audio_id={id}&token=&userid=0&signature={self.get_signature(key)}"
        else:
